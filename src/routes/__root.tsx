...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Archer's Tier List. Minecraft PvP rankings across Crystal, Sword, SMP, UHC, Pot, NethPot, Axe, Mace, Vanilla, Bedwars, and Archer. Managed by community testers." },
      { property: "og:title", content: "Archer's Tier List — Minecraft PvP Rankings" },
      { property: "og:description", content: "Archer's Tier List. Minecraft PvP rankings across Crystal, Sword, SMP, UHC, Pot, NethPot, Axe, Mace, Vanilla, Bedwars, and Archer. Managed by community testers." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Archer's Tier List — Minecraft PvP Rankings" },
      { name: "twitter:description", content: "Archer's Tier List. Minecraft PvP rankings across Crystal, Sword, SMP, UHC, Pot, NethPot, Axe, Mace, Vanilla, Bedwars, and Archer. Managed by community testers." },
